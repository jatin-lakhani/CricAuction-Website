...
use App\Http\Controllers\Api\V3\AuctionController;
use App\Http\Controllers\Api\V3\AuthController;
use App\Http\Controllers\Api\V3\PlayerController;
use App\Http\Controllers\Api\V3\PricingController;
use App\Http\Controllers\Api\V3\TeamController;
