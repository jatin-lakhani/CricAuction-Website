            ...
            <div class="container">
                <div class="data-content">
                    ...
                    <p>Supplemental terms and conditions or documents that may be posted on the Services from time to time
                        ...
                        to make changes or modifications to these Legal Terms at any time and for any reason. We will alert
                        you about any changes by updating the "Last updated" date of these Legal Terms, and you waive any
                        right to receive specific notice of each such change. It is your responsibility to periodically
                        review these Legal Terms to stay informed of updates. You will be subject to, and will be deemed to
                    ...
                    <h3 class="sub-heading">2. INTELLECTUAL PROPERTY RIGHTS</h3>
                    <h5 class="inter-heading">Our intellectual property</h5>
                    <p>We are the owner or the licensee of all intellectual property rights in our Services, including all
                        ...
                        marks, and logos contained therein (the "Marks").</p>
                    ...
                    <h5 class="inter-heading">Your use of our Services</h5>
                    ...
                    <div class="defination-account">
                        ...
                        <p>▪ download or print a copy of any portion of the Content to which you have properly
                            gained access.</p>
                    </div>
                    ...
                    <p>Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no
                        ...
                        any commercial purpose whatsoever, without our express prior written permission.</p>
                    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section
                        or elsewhere in our Legal Terms, please address your request to: __________. If we ever grant you
                    ...
                    <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms
                        and your right to use our Services will terminate immediately.</p>
                    <h5 class="inter-heading">Your submissions</h5>
                    ...
                    <p>Submissions: By directly sending us any question, comment, suggestion, idea, feedback, or other
                    ...
                    <p>You are responsible for what you post or upload: By sending us Submissions through any part of the
                        Services you:</p>
                    <div class="defination-account">
                        <p> ▪ confirm that you have read and agree with our "PROHIBITED ACTIVITIES" and will not
                            ...
                            deceitful, or misleading;</p>
                        <p> ▪ to the extent permissible by applicable law, waive any and all moral rights to any such
                            Submission;</p>
                        <p> ▪ warrant that any such Submission are original to you or that you have the necessary
                            rights and licenses to submit such Submissions and that you have full authority to grant
                            us the above-mentioned rights in relation to your Submissions; and</p>
                        <p> ▪ warrant and represent that your Submissions do not constitute confidential information.</p>

                    </div>
                    <p>You are solely responsible for your Submissions and you expressly agree to reimburse us for any and
                    ...
                    <h3 class="sub-heading">3. USER REPRESENTATIONS</h3>
                    <p>By using the Services, you represent and warrant that: (1) you have the legal capacity and you agree
                        to comply with these Legal Terms; (2) you are not a minor in the jurisdiction in which you reside;
                        (3) you will not access the Services through automated or non-human means, whether through a bot,
                        script or otherwise; (4) you will not use the Services for any illegal or unauthorized purpose; and
                        (5) your use of the Services will not violate any applicable law or regulation. If you provide any
                        ...
                        thereof).</p>
                    <h3 class="sub-heading">4. PROHIBITED ACTIVITIES</h3>
                    ...
                    <div class="defination-account">
                        ...
                        <p>▪ Circumvent, disable, or otherwise interfere with security-related features of the Services,
                            ...
                            limitations on the use of the Services and/or the Content contained therein.</p>
                        <p>▪ Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Services.</p>
                        <p>▪ Use any information obtained from the Services in order to harass, abuse, or harm another
                            person.</p>
                        ...
                        <p>▪ Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other
                        ...
                        <p>▪ Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or
                        ...
                        <p>▪ Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML,
                            JavaScript,
                            or other code.</p>
                        <p>▪ Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer
                            any of the software comprising or in any way making up a part of the Services.</p>
                        ...
                        <p>▪ Use a buying agent or purchasing agent to make purchases on the Services.</p>
                        <p>▪ Make any unauthorized use of the Services, including collecting usernames and/or email
                        ...
                        <p>▪ Use the Services as part of any effort to compete with us or otherwise use the Services and/or
                            the Content for any revenue-generating endeavor or commercial enterprise.</p>
                    </div>
                    <h3 class="sub-heading">5. USER GENERATED CONTRIBUTIONS</h3>
                    <p>The Services does not offer users to submit or post content. We may provide you with the opportunity
                    ...
                    <p>We do not assert any ownership over your Contributions. You retain full ownership of all of your
                        ...
                        from any legal action against us regarding your Contributions.</p>
                    <h3 class="sub-heading">7. SERVICES MANAGEMENT</h3>
                    <p>We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these
                        ...
                        to protect our rights and property and to facilitate the proper functioning</p>
                    <h3 class="sub-heading">8. TERM AND TERMINATION</h3>
                    ...
                    <p>If we terminate or suspend your account for any reason, you are prohibited from registering and
                        ...
                        pursuing.</p>
                    <h3 class="sub-heading">9. MODIFICATIONS AND INTERRUPTIONS</h3>
                    ...
                    <h3 class="sub-heading">10. GOVERNING LAW</h3>
                    <p>These Legal Terms shall be governed by the courts of India shall have exclusive jurisdiction to
                        resolve any dispute which may arise in connection with these Legal Terms.</p>
                    <h3 class="sub-heading">11. DISPUTE RESOLUTION</h3>
                    <h5 class="inter-heading">Negotiations</h5>
                    ...
                    <h5 class="inter-heading">Restrictions</h5>
                    <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties
                        ...
                        persons.</p>
                    <h5 class="inter-heading">Exceptions to Informal Negotiations and Arbitration</h5>
                    ...
                    <h3 class="sub-heading">12. CORRECTIONS
                    </h3>
                    ...
                    <h3 class="sub-heading">13. DISCLAIMER</h3>
                    ...
                    <h3 class="sub-heading">14. LIMITATIONS OF LIABILITIES</h3>
                    <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR
                        ...
                        OR. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR
                    ...
                    <h3 class="sub-heading">15. INDEMNIFICATION</h3>
                    ...
                    <h3 class="sub-heading">16. USER DATA</h3>
                    ...
                    <h3 class="sub-heading">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
                    <p>Visiting the Services, sending us emails, and completing online forms constitute electronic
                        ...
                        than electronic means.</p>
                    <h3 class="sub-heading">18. MISCELLANEOUS</h3>
                    ...
                    <h3 class="sub-heading">19. CONTACT US</h3>
                    ...
                    <h5 class="inter-heading">Support</h5>
                    <h5 class="inter-heading"><a href="mailto:info@argonitservices.com">info@argonitservices.com</a></h5>
                    <h5 class="inter-heading">India</h5>
                </div>
            </div>
        </section>
