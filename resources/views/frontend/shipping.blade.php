        ...
        <section class="section privacy" id="privacy">
            <div class="container">
                <div class="data-content">
                    <h5 class="inter-heading">Cricket Auction Community don’t ship any physical products. Since Cricket
                        Auction Community provides digital services (app Cricket Auction) and not physical products, this
                    ...
                    <div class="defination-account">
                        ...
                        <p>• We will not ship any physical products. Our testers will access your app electronically and
                            begin testing based on the chosen service package.</p>
                        <p>• You will be able to track the progress of your testing through our platform or receive updates
                            via email (depending on your chosen notification preferences).</p>
                    </div>
                    ...
                    <p>• We reserve the right to cancel your order if we are unable to provide the testing service due to
                    ...
                    <h5 class="inter-heading">By using Cricket Auction Community's services, you agree to the terms outlined
