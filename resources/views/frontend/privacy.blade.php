                ...
                <div class="data-content">
                    ...
                    <div class="defination-account">
                        ...
                        <p><strong>Company</strong> Company (referred to as either "the Company", "We", "Us" or "Our" in
                            this
                            Agreement) refers to Duho Corp, Hyderabad.</p>
                        ...
                        <p><strong>Usage</strong> Data refers to data collected automatically, either generated by the use
                            of
                            the
                    ...
                    <h5 class="inter-heading">Usage Data</h5>
                    ...
                    <h5 class="inter-heading">Use of Your Personal Data</h5>
                    ...
                    <div class="defination-account">
                        ...
                        <p><strong>To manage Your Account:</strong>to manage Your registration as a user of the Service. The
                            ...
                            Service that are available to You as a registered user.</p>
                        <p><strong>the performance of a contract:</strong> the development, compliance and undertaking
                        ...
                        <p><strong>To provide You</strong> with news, special offers and general information about other
                            ...
                            information.</p>
                        <p><strong>To manage Your requests:,</strong> To attend and manage Your requests to Us. For
                    ...
                    <p><strong>• With Service Providers:</strong> We may share Your personal information with Service
                        Providers to monitor and analyze the use of our Service, to contact You.<strong>• For business
                            transfers:</strong> We may share or transfer Your personal information in connection with, or
                        during negotiations of, any merger, sale of Company assets, financing, or acquisition of all
                        or a portion of Our business to another company.<strong>• With Affiliates:</strong> We may share
                        Your
                        information with Our affiliates, in which case we will require those affiliates to honor this
                        Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint
                    ...
                    <p><strong>• With other users:</strong> when You share personal information or otherwise interact in the
                        public areas with other users, such information may be viewed by all users and may be
                        publicly distributed outside.</p>
                    <p><strong>• With Your consent:</strong> We may disclose Your personal information for any other purpose
                        with Your consent</p>
                    <h5 class="inter-heading">Retention of Your Personal Data</h5>
                    ...
                    <h5 class="inter-heading">Transfer of Your Personal Data</h5>
                    ...
                    <h5 class="inter-heading">Delete Your Personal Data
                    </h5>
                    ...
                    <h5 class="inter-heading">Disclosure of Your Personal Data</h5>
                    <h5 class="inter-heading">Business Transactions</h5>
                    ...
                    <h5 class="inter-heading">Law enforcement</h5>
                    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required
                        ...
                        agency).</p>
                    <h5 class="inter-heading">Other legal requirements</h5>
                    ...
                    <h5 class="inter-heading">Security of Your Personal Data</h5>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission
                        ...
                        security.</p>
                    <h5 class="inter-heading">Children's Privacy</h5>
                    ...
                    <h5 class="inter-heading">Links to Other Websites</h5>
                    <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                    <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                    <h5 class="inter-heading">Changes to this Privacy Policy</h5>
                    ...
                    <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page. Contact Us</p>
                    <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                    <div class="defination-account">
                        <p>By <a href="mailto:info@argonitservices.com">info@argonitservices.com</a>
                        </p>
                        <p>By visiting this page on our website: <a href="https://cricauction.live/">cricauction.live</a>
                        </p>
                    </div>
                </div>
            </div>
